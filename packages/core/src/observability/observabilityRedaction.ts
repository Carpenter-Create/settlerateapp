 ...
 *
 * Canonical: `@settlerate/core/observability-redaction`
 * Authority: docs/adr/0003-observability-policy.md §4–5;
 * docs/adr/0005-shared-package-architecture.md (Epic 5 PR 3).
 *
 ...
 *
 * No `@sentry` SDK dependency — structural types only.
 */
