 ...
 *
 * Canonical: `@settlerate/core/billing-snapshot`
 * Authority: docs/adr/0005-shared-package-architecture.md (Epic 5 PR 3).
 *
 * Pure structural mappers only. Retrieval orchestration
 * (`resolveSubscriptionBillingSnapshot`) remains in runtime adapters.
 *
