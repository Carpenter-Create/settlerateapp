...
<body>
  <div class="container">
    ...
    <div class="interpretation-box">
      ...
      <p>
        This analysis presents modeled outcomes based on standardized assumptions. 
        It does not constitute financial advice, a recommendation, or a guarantee of future results.
      </p>
    </div>
    ...
    <footer class="footer">
      <p>
        SettleRate is an independent analytical platform. It does not originate, broker, or recommend mortgage products.
      </p>
    </footer>
  </div>
</body>
