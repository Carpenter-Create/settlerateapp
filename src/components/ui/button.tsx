...
/**
 * Button - Institutional focus state
 * 
 * Focus policy (LOCKED):
 * - Thin neutral outline on :focus-visible only
 * - NO glow ring or heavy shadow
 * - Mouse click won't show focus ring (uses :focus-visible)
 */
const buttonVariants = cva(
  [
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md",
    "text-sm font-medium transition-all duration-150",
    // Focus-visible: subtle neutral outline, NO ring
    "focus:outline-none",
