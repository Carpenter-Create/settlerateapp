 ...
 * `@settlerate/core/entitlement` via an approved Deno/Supabase import map and
 * CI proves Deno + deploy graph without this path (Epic 5 PR 6).
 */
export * from "../../../packages/core/src/entitlement/entitlementContract.ts";
