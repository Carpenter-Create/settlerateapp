...
**Epic 5 (Shared Core Package)** is **In progress — PR 2** (entitlement
extraction). ADR 0005 accepted; PR 0 complete/merged; PR 1 scaffold
complete/merged. PR 2 moves the entitlement contract into
`@settlerate/core/entitlement` with compatibility re-export shims.
PR 3–6 remain unauthorized. Authority:
