...
6. Epic 6 — Schema Reconciliation (**In progress — PR 2B**; ADR 0006/0007 accepted; PR 0–2A complete/merged; PR 2B = post-provenance drift refresh; later PR 2 slices unauthorized; requires Epic 4)  
...
Epic 6 **PR 2B** recomputes production-vs-repository drift after PR 2A
made migration-only reconstruction succeed. Evidence only — no schema
mutation, grant changes, or types regeneration. Do not begin later PR 2
slices or Epic 7+ automatically. Authority (accepted):
...
`docs/database/SCHEMA_DRIFT_REFRESH_PR2B.md`. See
`docs/PHASE8_1_EPIC_BOUNDARIES.md`.
