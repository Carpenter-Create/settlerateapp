...
| 0006 | Database schema source of truth | `0006-database-schema-source-of-truth.md` | Epic 6 | **accepted** (Epic 6 repository complete; production apply gated) |
| 0007 | Legacy schema disposition | `0007-legacy-schema-disposition.md` | Epic 6 | **accepted** (Epic 6 repository complete; production apply gated; ADR 0011 still required for advisor drops) |
