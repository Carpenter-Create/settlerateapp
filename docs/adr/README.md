...
| 0006 | Database schema source of truth | `0006-database-schema-source-of-truth.md` | Epic 6 | **accepted** (Epic 6 PR 2A in progress: provenance repair; later PR 2 slices unauthorized) |
| 0007 | Legacy schema disposition | `0007-legacy-schema-disposition.md` | Epic 6 | **accepted** (Epic 6 PR 2A in progress: provenance repair; later PR 2 slices unauthorized) |
