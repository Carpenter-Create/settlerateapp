...
| 0006 | Database schema source of truth | `0006-database-schema-source-of-truth.md` | Epic 6 | **accepted** (Epic 6 autonomous repository completion train; production apply gated) |
| 0007 | Legacy schema disposition | `0007-legacy-schema-disposition.md` | Epic 6 | **accepted** (Epic 6 autonomous repository completion train; production apply gated) |
